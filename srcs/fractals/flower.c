...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/03/26 16:30:50 by kibotrel          #+#    #+#             */
/*   Updated: 2019/03/26 16:57:54 by kibotrel         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		flower(t_env *env)
{
	...
	angle = 60 * M_PI / 180;
	p[0].x = 200 * env->cam->zoom - env->cam->offset_y;
	p[0].y = 300 * env->cam->zoom - env->cam->offset_x;
	p[1].x = 600 * env->cam->zoom - env->cam->offset_y;
	p[1].y = 300 * env->cam->zoom - env->cam->offset_x;
